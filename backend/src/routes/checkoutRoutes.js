...
import { createGuestOrder, createWompiWidgetConfig, getCheckoutQuote, getWompiTransactionById, handleWompiWebhook } from '../controllers/checkoutController.js';
...
router.post('/quote', checkoutOrderLimiter, getCheckoutQuote);
